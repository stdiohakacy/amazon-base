import { BaseDomainEntity } from '../domain/entities/base.entity';
import { BaseValueObject } from '../domain/value-objects/base.vo';

function isEntity(obj: unknown): obj is BaseDomainEntity<unknown> {
  /**
  ...
  return (
    ...
    BaseValueObject.isValueObject((obj as BaseDomainEntity<unknown>).id)
  );
}
