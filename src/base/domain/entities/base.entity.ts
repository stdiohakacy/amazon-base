import { convertPropsToObject } from '../../utils/object.util';
...
export const isEntity = <T>(object: unknown): object is BaseDomainEntity<T> => {
  return object instanceof BaseDomainEntity;
};
...
export abstract class BaseDomainEntity<EntityProps> {
  /**
  ...
  static isEntity(entity: unknown): entity is BaseDomainEntity<unknown> {
    return entity instanceof BaseDomainEntity;
  }
   ...
   * @param object Entity
   */
  public equals(object?: BaseDomainEntity<EntityProps>): boolean {
    ...
    if (!BaseDomainEntity.isEntity(object)) {
      return false;
    }
   ...
   * @memberof Entity
   */
  public getProps(): EntityProps & BaseDomainEntityProps {
    const propsCopy = {
      id: this._id,
